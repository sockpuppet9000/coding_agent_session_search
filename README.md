...
| `CASS_DB_RESIDENT_FTS_AUTO_REPAIR` | 0 | Opt in to repairing an existing DB-resident `fts_messages` cache during full-index maintenance; missing `fts_messages` stays absent. |
| **Semantic Search** | | |
